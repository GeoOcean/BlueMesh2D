...
> **BlueMesh2D** is the successor of [**PyMesh2D**](https://github.com/GeoOcean/pymesh2d). The repository has been recreated under its new name as part of the [BlueMath](https://github.com/GeoOcean/BlueMath) ecosystem. While the repository history has changed, the codebase and its development continue from the original project.
